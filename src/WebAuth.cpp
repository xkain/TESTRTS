...
namespace WebAuth {
  ...
  // g_loginFailCount/g_loginLockUntil ci-dessus restent PARTAGÉS entre les deux versions -- même
  // compteur anti brute-force quelle que soit la voie empruntée, à l'identique du partage actuel
