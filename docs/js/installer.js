...
// esm.sh plutôt qu'unpkg?module : ce dernier échoue à résoudre en ESM une dépendance
// transitive d'esptool-js (atob-lite, "does not provide an export named 'default'") quand
// flash.js est importé seul (hors du bundle pré-empaqueté install-button.js, qui n'a pas ce
// souci) -- vérifié en conditions réelles avant de choisir esm.sh, qui gère cette conversion
// CJS -> ESM correctement pour ce module précis.
import { flash } from 'https://esm.sh/esp-web-tools@10/dist/flash.js';
